<?php
// Heading
$_['heading_title'] = 'Cointopay International B.V. Fiat';

// Text
$_['text_description'] = '<strong>Having trouble?</strong> Please submit the KYC/AML information on the Cointopay website in the account section. Only when your account is verified can you do shopping cart check outs and start receiving customer funds. Apologies but this is required for compliance reasons.';
$_['text_edit'] = 'Edit Cointopay Fiat';
...
$_['help_redirect_url_hint'] = 'The Redirect URL may be specified in your Cointopay.com Account.';
$_['help_display_name_hint'] = 'The text that people see when making a purchase.';
$_['help_merchantID_hint'] = 'Enter your ID from cointopay account';
